...
(function($) {
	...
	skel.init({
		...
		breakpoints: {
			...
			wide:		{ range: '-1680', href: 'css/style-wide.css', containers: 900, grid: { gutters: 40 } },
			normal:		{ range: '-1280', href: 'css/style-normal.css', containers: 860, grid: { gutters: 30 }, lockViewport: true },
			...
			mobilep:	{ range: '-480', href: 'css/style-mobilep.css', grid: { collapse: 2 }, containers: '95%' }
		}
	}, {
		layers: {
			layers: {
