 ...
 */
 ...
 $_pagi_enlace .= 'filtro='.$filtro.'&'; 
 // echo "<p>_pagi_enlace = $_pagi_enlace</p>";
 //------------------------------------------------------------------------


//Esto lo hago para saber si estoy en una página con el htaccess. 
...
if (!$_pagi_htaccess){
	...
	// voy a propagar las variables de paginación de una manera distinta
	// La variable $_pagi_navegacion contendrá los enlaces a las páginas.
	//echo "<p>_pagi_enlace = $_pagi_enlace</p>";
 ...
 */
 ...
 $_pagi_info = " <span class=fuente8><b>Se muestra la receta $_pagi_desde hasta la $_pagi_hasta de un total de $_pagi_totalReg recetas.</b></span>";
